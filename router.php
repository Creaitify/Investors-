 ...
 *
 * Serves real files (css, js, assets) directly and sends "/" and "/investors"
...
// Only the investor landing page exists. The retired /doctors route is a 404.
if (!in_array(rtrim(strtolower($path), '/'), ['', '/investors'], true)) {
